...
namespace Pyz\Glue\GlueRelationshipManifestApplication;
 ...
 */
class GlueRelationshipManifestApplicationDependencyProvider extends SprykerGlueApplicationDependencyProvider
{
    /**
     * {@inheritDoc}
     *
